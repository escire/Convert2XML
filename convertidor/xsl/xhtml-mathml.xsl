<!--
	...
	<a href="http://www.w3.org/Consortium/Legal/copyright-software-19980720">W3C Software Notice and License</a>.
-->
...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!--
  <xsl:import href="file:///Users/virtual/Desktop/convertidor/mathml/xsl/omml2mml.xsl"/>
	<xsl:import href="omml2mml.xsl"/>
	<xsl:import href="omml2mml.xsl"/>
	-->
	<!--  <xsl:import href="OMML2MML.XSL"/> -->
...
<xsl:template match="h:head[not(h:title)]">
	<head>
		<xsl:copy-of select="@*"/>
		<title>
			<xsl:value-of select="../h:body/descendant::*[self::h:h1|self::h2][1]"/>
		</title>
		<xsl:apply-templates/>
	</head>
</xsl:template>
