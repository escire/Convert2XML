<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="jats.Default" UICulture="auto" Culture="auto"%>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title><asp:Literal runat="server" Text="<%$Resources:Languaje,contact%>" /></title>
...
<body>
    <form id="form1" runat="server">
        ...
        <footer id="footer" role="contentinfo">
		    <div class="row">
                <div>
                    <h4 class="widget-title"><asp:Literal runat="server" Text="<%$Resources:Languaje,contact%>" /></h4>			
